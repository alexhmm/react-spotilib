import { albumTranslationsDE } from './de/album.translations.de';
import { appTranslationsDE } from './de/app.translations.de';
import { artistTranslationsDE } from './de/artist.translations.de';
...
export const translationsDe = {
  album: albumTranslationsDE,
  app: appTranslationsDE,
  artist: artistTranslationsDE,
